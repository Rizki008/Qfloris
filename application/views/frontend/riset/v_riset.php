...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="#"><b>Toko</b>Qflorist</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Riset Password</p>
                ...
                echo form_open('pelanggan/riset');
                ?>
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block">Riset Password</button>
                    </div>
                    <!-- /.col -->
                </div>
                <?php echo form_close() ?>
                ...
                <a href="<?= base_url('pelanggan/login') ?>" class="text-left">Login</a>
            </div>
            <!-- /.login-card-body -->
        </div>
    </div>
