...
class Pemilik extends CI_Controller
{
    ...
    public function lap_harian()
    {
        ...
        $data = array(
            ...
            'isi' => 'pemilik/laporan/v_lap_harian'
        );
        $this->load->view('pemilik/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_bulanan()
    {
        ...
        $data = array(
            ...
            'isi' => 'pemilik/laporan/v_lap_bulanan'
        );
        $this->load->view('pemilik/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_tahunan()
    {
        ...
        $data = array(
            ...
            'isi' => 'pemilik/laporan/v_lap_tahunan'
        );
        $this->load->view('pemilik/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_stock()
    {
        ...
        $data = array(
            ...
            'tahun' => $tahun,
            'laporan' => $this->m_laporan->lap_harian($tanggal, $bulan, $tahun),
            'isi' => 'pemilik/laporan/v_lap_stock'
        );
        $this->load->view('pemilik/v_wrapper', $data, FALSE);
    }
}
